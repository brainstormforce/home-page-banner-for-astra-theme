# AI Agent Guide — Home Page Banner for Astra Theme

## Quick Start for AI Agents

1. **Entry point:** Start at `home-page-banner-for-astra-theme.php` to understand plugin initialization
...
4. **Text domain:** Use `home-page-banner` for all translatable strings
...
1. Wrap strings in `__( 'text', 'home-page-banner' )` or `esc_html__( 'text', 'home-page-banner' )`
...
- [ ] Text domain `home-page-banner` used for all user-facing strings
