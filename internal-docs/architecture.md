# Architecture — Home Page Banner for Astra Theme

## Overview

Home Page Banner for Astra Theme is a WordPress plugin that follows standard WordPress plugin architecture patterns.

## Entry Point

The plugin entry point is `home-page-banner-for-astra-theme.php`, which:
...
1. WordPress loads the plugin via `home-page-banner-for-astra-theme.php`
